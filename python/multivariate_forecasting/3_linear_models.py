...
import os
import sys
from numpy import load, loadtxt, nan, isnan, count_nonzero, unique, array
...
train = load(dirname + '/data/dsg/supervised_train.npy', allow_pickle=True)
test = load(dirname + '/data/dsg/supervised_test.npy', allow_pickle=True)
print(train.shape, test.shape)
# load test chunks for validation
testset = loadtxt(dirname + '/data/dsg/naive_test.csv', delimiter=',')
